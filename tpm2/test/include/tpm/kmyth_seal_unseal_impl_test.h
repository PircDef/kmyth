 ...
 *
 * Provides unit tests for the seal/unseal functions
 * implemented in tpm2/src/tpm/kmyth_seal_unseal.c
 */

#ifndef KMYTH_SEAL_UNSEAL_IMPL_TEST_H
#define KMYTH_SEAL_UNSEAL_IMPL_TEST_H_

/**
 * This function adds all of the tests contained in kmyth_seal_unseal_impl.c to a
